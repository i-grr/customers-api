...
public class ServiceProvidedController {
	...
	@GetMapping
	public List<ServiceProvided> find (@RequestParam(value = "name", required = false,  defaultValue = "") String name,
									   @RequestParam(value = "month", required = false) Integer month) {
		return serviceProvidedRepository.findByCustomerNameAndMonth("%" + name + "%", month);
	}
